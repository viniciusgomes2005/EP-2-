...
if not posicao_valida(frota,linhapa,colunapa,orientacaopa,4):
...
for i in range(2):
    ...
    if not posicao_valida(frota,linhant,colunant,orientacaont,3):
...
for i in range(3):
    ...
    if not posicao_valida(frota,linhac,colunac,orientacaoc,2):
...
for i in range(4):
    ...
    if not posicao_valida(frota,linhas,colunas,"horizontal",1):
